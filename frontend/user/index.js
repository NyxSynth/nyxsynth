    ...
    <Router>
      <div className="nyxsynth-app">
        <header className="app-header">
          <div className="logo">
            <img src="/assets/logo.svg" alt="NyxSynth Logo" />
            <h1>NyxSynth</h1>
          </div>
          <nav className="main-nav">
            <Link to="/">Home</Link>
            <Link to="/wallet">Wallet</Link>
            <Link to="/staking">Neural Staking</Link>
        ...
        <main className="app-content">
          <Routes>
            ...
            <Route path="/login" element={<Login setWallet={setWallet} setIsLoggedIn={setIsLoggedIn} />} />
            <Route path="/wallet" element={
              isLoggedIn ? <Wallet wallet={wallet} /> : <Navigate to="/login" />
            } />
            <Route path="/staking" element={
              isLoggedIn ? <Staking wallet={wallet} /> : <Navigate to="/login" />
            } />
